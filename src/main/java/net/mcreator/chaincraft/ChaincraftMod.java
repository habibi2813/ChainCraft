 ...
 *
 */
package net.mcreator.chaincraft;
...
@Mod("chaincraft")
public class ChaincraftMod {
	public static final Logger LOGGER = LogManager.getLogger(ChaincraftMod.class);
	public static final String MODID = "chaincraft";

	public ChaincraftMod() {
